...
//						System.out.println("Frame Gp Commissionning re√ßue:");
...
//		};
			...
			public void gpCommandReceived(GpCommand command) {
				switch (command.getCommandId()) {
					...
					case 160: //attribute reporting
						...
						switch(type) {
						case 1026:
							str_type="Mesure de la tempÈrature";
							break;
						case 1029:
							str_type="Mesure de l'humiditÈ";
							break;
						default:
							str_type="Unknown";
							break;
						}
						System.out.print("" + str_type + " reÁue : ");
	...
	private static EmberGpSinkTableEntry buildSinkTableEntry(EzspGpepIncomingMessageHandler frame) {
		...
		//bit 6 --> RxOnCapability -‚àí> 0 
		//bit 7 --> FixedLocation --> 1
		//bit 8 --> assignedalias --> 0
		//bit 9 --> security use --> 1
		//bits 10-15 reserved
		//valeur 0b 0000011101|000000 --> 3904 + ExtendedOptions full √† 0 ?--> 30408704/486539264
